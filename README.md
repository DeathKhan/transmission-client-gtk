...
Upstream `transmission-gtk` always embeds its own BitTorrent session. This build adds a full HTTP RPC path so you can manage the **same daemon** already in use—without switching to Qt or a separate remote-only app.
